...
class CommonData(InputData):
    ...
    # all waste_pr_index
    All_Waste_Pr_Index = Waste_Pr_Index + Collection_Index + Reprocessing_Index
    ...
    Index = [
        ...
        "Paper_Bags",
        "Mixed_Paper",
        "Paper_Non_recyclable",
        "HDPE_Translucent_Containers",
        "HDPE_Pigmented_Containers",
        "PET_Containers",
        "Plastic_Other_1_Polypropylene",
        "Plastic_Other_2",
        "Mixed_Plastic",
        "Plastic_Film",
        ...
        "Aluminum_Foil",
        "Aluminum_Other",
        "Ferrous_Non_recyclable",
        "Al_Non_recyclable",
        "Glass_Brown",
        "Glass_Green",
        "Glass_Clear",
        "Mixed_Glass",
        "Glass_Non_recyclable",
        "Misc_Organic",
        "Misc_Inorganic",
        "E_waste",
        "Bottom_Ash",
        "Fly_Ash",
        "Diapers_and_sanitary_products",
    ]
